...
extern const UINT8 wiced_bt_sdp_db[];
...
#define KB_LED_CAPS         WICED_GET_PIN_FOR_LED(WICED_PLATFORM_LED_1)
#define KB_LED_BLUE         WICED_GET_PIN_FOR_LED(WICED_PLATFORM_LED_2)
#ifdef KEYBOARD_PLATFORM
 #define KB_LED_GREEN       WICED_GET_PIN_FOR_LED(WICED_PLATFORM_LED_3)
 #define KB_LED_RED         WICED_GET_PIN_FOR_LED(WICED_PLATFORM_LED_4)
#else
...
#define LED_OFF_LEVEL 1          // voltage high to turn off LED
 ...
 #define KB_LED_LE_LINK          KB_LED_BLUE
 #define KB_LED_ERBDR_LINK       KB_LED_GREEN
#else
 #define KB_LED_ERROR            KB_LED_BLUE
 #define KB_LED_LE_LINK          KB_LED_BLUE
 #define KB_LED_ERBDR_LINK       KB_LED_BLUE
#endif
