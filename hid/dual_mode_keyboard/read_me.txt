...
Overview
--------
The Dual Mode Keyboard application is a single chip SoC. It provides a turnkey solution
using on-chip keyscan HW component. It can operate in both BR/EDR Bluetooth mode and
...
4. Press any key to start BR/EDR pairing, then pair with a PC or Tablet
5. To pair with LE host, during BR/EDR pairing, press any key again to stop BR/EDR pairing and start LE advertisment.
6. Once connected, it becomes the keyboard of the PC or Tablet.

In case you don't have the right hardware, reference keyboard, platform CYW920819REF-KB-01, which is required to support the 818
key matrix used, you can build evaluation board version in conjunction to work with ClientControl. in this case,
the key-matrix is disabled. You can test the basic Bluetooth functions and mimic to send key report by using ClientControl.
...
Notes
-----
The application GATT and SDP databases are located in wiced_bt_cfg.c
